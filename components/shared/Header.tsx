...
const settingsUrls: Record<Role, string> = {
    ...
    >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <div
          className={
            isLight
              ? "relative flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-gray-100"
              : "relative flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-[#1e293b]"
          }
        >
          <NotificationBell role={role} token={store.token} isLight={isLight} />
        </div>
        <div className="relative z-50">
          ...
          {profileOpen && (
            <>
              ...
              <div className={
                isLight
                  ? "absolute right-0 top-full z-50 mt-1 w-48 rounded-lg border border-gray-200 bg-white py-1 shadow-lg"
                  : "absolute right-0 top-full z-50 mt-1 w-48 rounded-lg border border-[#334155] bg-[#1e293b] py-1 shadow-lg"
              }>
                ...
                <a
                  href={settingsUrls[role]}
                  onClick={() => setProfileOpen(false)}
                  className={
                    isLight
                      ? "flex w-full items-center gap-2 border-b border-gray-100 px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-50"
                      : "flex w-full items-center gap-2 border-b border-[#334155] px-3 py-2 text-left text-sm text-gray-300 hover:bg-white/5"
                  }
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className={
                    isLight
                      ...
                      : "flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-red-400 hover:bg-red-500/10"
                  }
                >
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
